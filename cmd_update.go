...
func init() {
	...
	updateWorkCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	...
	updateEducationCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	...
	updateLanguageCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
