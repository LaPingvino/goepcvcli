...
func init() {
	...
	addWorkCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	...
	addEducationCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	...
	addLanguageCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")

	// Skill — inputFile via persistent flag on parent
	addSkillCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")

	// Contact
	addContactCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
