...
func init() {
	removeWorkCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	removeEducationCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	removeLanguageCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	removeSkillCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
	removeContactCmd.Flags().StringVarP(&inputFile, "input", "i", "cv.json", "input JSON file")
